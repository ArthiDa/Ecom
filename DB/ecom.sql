...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3011688720ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecom&table=product">`ecom`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecom&table=orders">`ecom`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecom&table=catagory">`ecom`.`catagory`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecom&table=customer">`ecom`.`customer`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=food-order&table=tbl_food">`food-order`.`tbl_food`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=demodb&table=orders">`demodb`.`orders`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=demodb&table=order_details">`demodb`.`order_details`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="315075304c2533244e76443428526b46">
    ...
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ecom" targettable="product">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecom" targettable="catagory">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `catagory`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecom" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `product`(`catagoryID`, `Title`, `ImgName`, `Price`, `Des`) 
VALUES 
(&#039;1&#039;,&#039;Apple iPhone 13 Pro Max&#039;,&#039;Iphone-13.jpg&#039;,&#039;1,099.00&#039;,&#039;Apple iPhone 13 Pro Max smartphone. Announced Sep 2021. Features 6.7″ display, Apple A15 Bionic chipset, 4352 mAh battery, 1024 GB storage, 6 GB RAM&#039;),
(&#039;1&#039;,&#039;SAMSUNG Galaxy F22&#039;,&#039;Samsung-Galaxy.jpg&#039;,&#039;256.00&#039;,&#039;Samsung Galaxy F22 Android smartphone. Announced Jul 2021. Features 6.4″ display, MT6769V chipset, 6000 mAh battery, 128 GB storage, 6 GB RAM.&#039;),
(&#039;1&#039;,&#039;Oppo F21 Pro 5G&#039;,&#039;oppo-f21-pro-5g.jpg&#039;,&#039;449.90&#039;,&#039;Oppo F21 Pro Android smartphone. Announced Apr 2022. Features 6.43″ display, Snapdragon 680 4G chipset, 4500 mAh battery, 128 GB storage, 8 GB RAM&#039;),
(&#039;1&#039;,&#039;Vivo iQOO 9&#039;,&#039;vivo-iqoo-9.jpg&#039;,&#039;635.00&#039;,&#039;vivo iQOO 9 Android smartphone. Announced Feb 2022. Features 6.56″ display, Snapdragon 888+ 5G chipset, 4350 mAh battery, 256 GB storage, 12 GB RAM&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecom" targettable="product">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="food-order" targettable="tbl_food">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `tbl_food`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecom" targettable="orders">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `product`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecom" targettable="customer">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
